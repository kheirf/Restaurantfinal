...
class SubscribesControllerTest < ActionController::TestCase
  ...
  test "should create subscribe" do
    assert_difference('Subscribe.count') do
      post :create, subscribe: { contactNo: @subscribe.contactNo, customerName: @subscribe.customerName, email: @subscribe.email, password: @subscribe.password }
    end
  ...
  test "should update subscribe" do
    put :update, id: @subscribe, subscribe: { contactNo: @subscribe.contactNo, customerName: @subscribe.customerName, email: @subscribe.email, password: @subscribe.password }
    assert_redirected_to subscribe_path(assigns(:subscribe))
  end
